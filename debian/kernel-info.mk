...
# Kernel base version
KERNEL_BASE_VERSION = 3.18-140

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=htc_oce user_debug=31 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidkey.dummy=1 androidboot.selinux=permissive
...
FLASH_INFO_DEVICE_IDS = oce_dugl
...
BUILD_PATH = /usr/lib/gcc-4.9-aarch64-linux-android/bin
